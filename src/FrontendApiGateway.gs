var TAZMANY_FRONTEND_API_ACTIONS_ = Object.freeze({
  ...
  apiCreateOrderReservation: routeFrontendApi_(3, 3, function (args) { return apiCreateOrderReservation(args[0], args[1], args[2]); }),
  apiGetMyOrder: routeFrontendApi_(2, 2, function (args) { return apiGetMyOrder(args[0], args[1]); }),
  apiCancelMyOrder: routeFrontendApi_(3, 3, function (args) { return apiCancelMyOrder(args[0], args[1], args[2]); }),
